            ...
            <>
              <div className="space-y-3 p-2 md:py-20 md:px-40">
                ...
                >
                  ...
                  <div className="bg-ray-800/50 backdro-blur-sm rounded-ull p-2 py-6">
                    <div className="flex items-center justify-between">
                      {/* WORD FOUND */}
                      ...
                      {/* POINTS EARNED */}
                      <div className="flex flex-col items-cnter px-4 py-2 rounded-full">
                        <span className='text-sm md:text-xltext-white font-bold md:text-white'>Points Earned</span>
                        <span
                          className={`text-sm font-bold md:text-xl  transition-all duration-300 ${isAnimating
                ...
                {/* Current Word */}
                <div className="bg-gray-900/90 backdop-blur-sm rounded-xl p-6 borer border-gray-700">
                ...
                {/* Available Letters */}
                <div className="bg-gray-900/90 backdro-blur-sm rounded-xl p-6 boder border-gray-00">
